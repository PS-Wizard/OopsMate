use crate::eval::nnue::compat::{Color, ColorExt};
#[cfg(test)]
use crate::eval::nnue::arch::{FT_PERMUTE_BLOCK_I16S, FT_PERMUTE_GROUP_I16S, FT_PERMUTE_INVERSE_ORDER};
...
mod tests {
    ...
    use crate::eval::nnue::compat::Color;
