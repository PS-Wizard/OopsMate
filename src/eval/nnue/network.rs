...
use crate::eval::nnue::layout::{repack_dense_weights, repack_feature_transformer};
use crate::eval::nnue::loader::{
...
mod tests {
    ...
    use crate::eval::nnue::constants::{BIG_NETWORK_HASH, SMALL_NETWORK_HASH};
    use crate::eval::nnue::compat::{Color, Position, Square};
