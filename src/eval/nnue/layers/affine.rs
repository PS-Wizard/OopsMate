...
use crate::eval::nnue::arch::DENSE_CHUNK_SIZE;
use crate::eval::nnue::constants::{FC1_OUTPUTS, FC1_PADDED_INPUT_DIMS};
use crate::eval::nnue::network::DenseLayer;
...
mod tests {
    ...
    use crate::eval::nnue::aligned::{AlignedSlice, CacheAligned};
    use crate::eval::nnue::constants::{FC1_OUTPUTS, FC1_PADDED_INPUT_DIMS};
    use crate::eval::nnue::network::DenseLayer;
