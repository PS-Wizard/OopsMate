...
use crate::oopsmate_core::{Color, Piece, Position};
use crate::update::{
    accum_add, accum_add1_sub1_into_both, accum_add1_sub2_into_both, accum_add2_sub1_into_both,
    accum_add_into_both, accum_add_sub, accum_sub, accum_sub_into_both, psqt_add,
    psqt_add1_sub1_into_both, psqt_add1_sub2_into_both, psqt_add2_sub1_into_both,
    psqt_add_into_both, psqt_add_sub, psqt_sub, psqt_sub_into_both,
};
...
impl<const HALF_DIMS: usize> FinnyCache<HALF_DIMS> {
    ...
    fn entry_mut(
        &mut self,
        perspective: Color,
        king_square: crate::oopsmate_core::Square,
        ...
        for piece in PIECES {
            ...
            while to_remove != 0 {
                ...
                removed[removed_len] = feature_index_from_piece_code(
                    perspective,
                    crate::oopsmate_core::encode_piece(piece, color),
                    crate::oopsmate_core::Square::from_raw(square),
                    king_square,
                );
                removed_len += 1;
            }
