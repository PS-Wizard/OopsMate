...
mod tests {
    ...
    fn dirty_piece_extracts_capture_promotion() {
        ...
        assert_eq!(
            dirty.piece_codes[0],
            encode_piece(Piece::Pawn, crate::oopsmate_core::Color::White)
        );
        ...
        assert_eq!(
            dirty.piece_codes[2],
            encode_piece(Piece::Queen, crate::oopsmate_core::Color::White)
        );
    ...
    fn king_move_requires_refresh_for_matching_perspective() {
        ...
        assert!(dirty.requires_refresh(crate::oopsmate_core::Color::White));
        assert!(!dirty.requires_refresh(crate::oopsmate_core::Color::Black));
    }

    #[test]
    fn piece_from_code_matches_core_encoding() {
        let white_queen = encode_piece(Piece::Queen, crate::oopsmate_core::Color::White);
